...
class AggregatedMetrics:
    ...
    def __init__(
        ...
        segmented_lcom4: SegmentedMetrics = SegmentedMetrics(),
    ) -> None:
        self.loc = loc
        ...
        self.avg_lcom4_per_class = avg_lcom4_per_class
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "avgLcom4": round(self.avg_lcom4_per_class, 2),
    ...
    def to_dict_segmentation_percent(self) -> dict:
        return {k: v.to_dict_with_percent() for k, v in self.segmentation_data.items()}
