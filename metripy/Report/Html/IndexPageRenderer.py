    ...
    def render(self, metrics: ProjectMetrics):
        ...
        self.render_template(
            "index.html",
            {
                ...
                "total_code_metrics_functions": metrics.total_code_metrics_functions.to_dict(),
                "total_code_metrics_functions_segmentation": metrics.total_code_metrics_functions.to_dict_segmentation_percent(),
                "has_total_code_metrics_functions_trend": False,
