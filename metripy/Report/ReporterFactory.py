...
from metripy.Report.Json.GlCodequalityReporter import GlCodequalityReporter
...
class ReporterFactory:
    ...
    def create(
        ...
        elif config.type == "gl-codequality-report":
            return GlCodequalityReporter(config, output)
        else:
